...
namespace Lets2Chat.Areas.Identity.Pages.Account.Manage
{
    public partial class EmailModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            if (user == null)
            {
                return NotFound($"Mail adresi bulunamadı'{_userManager.GetUserId(User)}'.");
            }
        ...
        public async Task<IActionResult> OnPostChangeEmailAsync()
        {
            ...
            if (Input.NewEmail != email)
            {
                ...
                await _emailSender.SendEmailAsync(
                    Input.NewEmail,
                    "Confirme seu email",
                    $"Lütfen hesabınızı onaylayın <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'></a>.");

                StatusMessage = "Gönderilen e-postayı değiştirmek için onay bağlantısı. Lütfen emailinizi kontrol edin.";
                return RedirectToPage();
            }

            StatusMessage = "E-postanız değiştirilmedi..";
            return RedirectToPage();
        }
